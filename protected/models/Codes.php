...
class Codes extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('code_kind, code_no', 'required'),
			array('code_kind', 'numerical', 'integerOnly'=>true),
			array('code_no', 'length', 'max'=>20),
			array('code_name', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('code_kind, code_no, code_name', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('code_kind',$this->code_kind);
