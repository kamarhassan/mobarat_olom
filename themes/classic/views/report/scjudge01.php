...
<div id='searchcontrol'>
    ...
    <table>
        ...
        <tr>
            ...
            <td><a href="<?php echo $this->createAbsoluteUrl('Personjudge/PrintPartAllJudge'); ?>" target="_blank"  class="btn green icon-print"><b><?php echo '   '. 'طباعة شهادة تقدير لجمبع الحكام'?></b></a></td>
        </tr>
    </table>
    </form>
    <?php
