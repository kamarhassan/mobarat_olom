...
<div class="row">
  ...
  echo CHtml::ajaxLink('<button type="button"  class="btn blue">
          <i class="icon-check"></i>
        </button>', array('MbAdmin/SchoolPresent'), array('update' => '#k' ,'data' => array('id' => $p->school_id)));
  }
  else{
  echo CHtml::ajaxLink('<button type="button"  class="btn green">
          <i class="icon-minus"></i>
        </button>', array('MbAdmin/SchoolDeletePresent'), array('update' => '#k' ,'data' => array('id' => $p->school_id)));
  }
 ...
 <td>
                                ...
                                <?php $ka=MbKadaa::model()->findAll('kadaa_id =' . $p->school_kadda);
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            foreach ($project as $p) {
                                $c1=12;$c2=11;$c3=11;$c4=0;$c5=0;$c6=0;$c7=0;
                                $eo++;
                                if ($eo % 2 == 0)
                                    $cl = "even";
                                else
  ...
  $isPresentProject = PresentProject::model()->findAll('projectID= ' .$p->project_id);
  foreach ($isPresentProject as $k)
  if($k->present==0){
  
  echo CHtml::ajaxLink('<button type="button"  class="btn blue">
          <i class="icon-check"></i>
        </button>', array('MbAdmin/ProjectPresent'), array('update' => '#z' ,'data' => array('id' => $p->project_id)));
  }
  else{
  echo CHtml::ajaxLink('<button type="button"  class="btn green">
          <i class="icon-minus"></i>
        </button>', array('MbAdmin/DeleteProjectPresent'), array('update' => '#z' ,'data' => array('id' => $p->project_id)));
  }
...
//        }','data' => array('id' => $p->project_id)));
          ...
          <i class="icon-edit"></i>
                        ...
                        <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $c1 + $c2 + $c3; ?>%">
                            <span class="sr-only">40% Complete (success)</span>
                            <?php echo $c1 + $c2 + $c3 + $c4+$c5+$c6+$c7; ?>%
                        </div>
                    </div>
                                    </td>
