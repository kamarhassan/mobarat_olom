...
<div class="row">
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat green">
            ...
            <a class="more" href="<?php echo $this->createAbsoluteUrl('Admin/reportAcceptedSchool'); ?>">
                دخول <i class="m-icon-swapleft m-icon-white"></i>
            </a>
        </div>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat purple">
            ...
            <a class="more" href="<?php echo $this->createAbsoluteUrl('MbAdmin/ProjectReport'); ?>">
                دخول <i class="m-icon-swapleft m-icon-white"></i>
            </a>
        </div>
    </div>
    ...
    <div class = "col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class = "dashboard-stat green">
            ...
            <a class = "more" href = "<?php echo $this->createAbsoluteUrl('MbAdmin/archive') ?>">
                دخول <i class = "m-icon-swapleft m-icon-white"></i>
            </a>
        </div>
    </div>
...
<div class = "row">
    ...
    <div class = "col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class = "dashboard-stat orange">
            ...
            <div class = "details">
                <div class = "number">تسجيل الأعضاء</div>
                <div class = "desc">بالمباراة</div>
            </div>
            <a class = "more" href = "<?php echo $this->createAbsoluteUrl('MbProject/underConstruction'); ?>">
                دخول <i class = "m-icon-swapleft m-icon-white"></i>
            </a>
        </div>
    </div>
    ...
    <div class = "col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class = "dashboard-stat bordo">
            ...
            <div class = "details">
                <div class = "number">تقرير بأعضاء</div>
                <div class = "desc">المباراة</div>
            </div>
            <a class = "more" href = "<?php echo $this->createAbsoluteUrl('MbProject/underConstruction'); ?>">
                دخول <i class = "m-icon-swapleft m-icon-white"></i>
            </a>
...
<div class="row">
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat blue">
            ...
            <a class="more" href="<?php echo $this->createAbsoluteUrl('MbAdmin/indexFullyReport'); ?>">
                دخول <i class="m-icon-swapleft m-icon-white"></i>
            </a>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat orange">
            ...
            <a class="more" href="<?php echo $this->createAbsoluteUrl('MbProject/projectNotComplete'); ?>">
                دخول <i class="m-icon-swapleft m-icon-white"></i>
            </a>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat orange">
            ...
            <a class="more" href="<?php echo $this->createAbsoluteUrl('MbAdmin/reportOldSchool'); ?>">
                دخول <i class="m-icon-swapleft m-icon-white"></i>
            </a>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat blue">
            ...
            <a class="more" href="<?php echo $this->createAbsoluteUrl('MbProject/projectArchive'); ?>">
                دخول <i class="m-icon-swapleft m-icon-white"></i>
            </a>
        </div>
    </div>
...
<div class="row">
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat red">
            ...
            <a class="more" href="<?php echo $this->createAbsoluteUrl('MbProject/trophy'); ?>">
                دخول <i class="m-icon-swapleft m-icon-white"></i>
            </a>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat green">
            ...
            <a class="more" href="<?php echo $this->createAbsoluteUrl('MbAdmin/reportNotCompleteSchool'); ?>">
                دخول <i class="m-icon-swapleft m-icon-white"></i>
            </a>
        </div>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat green">
            ...
            <a class="more" href="<?php echo $this->createAbsoluteUrl('MbAdmin/reportNotCompleteStudent'); ?>">
                دخول <i class="m-icon-swapleft m-icon-white"></i>
            </a>
        </div>
    </div>
