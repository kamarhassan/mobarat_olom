...
<!--
            <li class="">
                ...
                <ul class="sub-menu">
                    <li >
                        <a href="<?php echo $this->createAbsoluteUrl('Project/listprojectsforupdatestd/persid/'.$clsPerson->person_id); ?>">
                            تعديل المشروع</a>
                    </li>
                    <li >
                        <a href="<?php  echo $this->createAbsoluteUrl('Project/listprojectsstd/persid/'.$clsPerson->person_id); ?>">
                            تقرير بالمشروع</a>
                    </li>
                </ul>
