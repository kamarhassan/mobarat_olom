...
<div class="row inbox">
    <div class="col-md-2">
        <ul class="inbox-nav margin-bottom-10">
            ...
            <li class="inbox active"><a class="btn" href="<?php echo $this->createAbsoluteUrl('MbMessage/send'); ?>"  data-title="Sent">الرسائل المرسلة</a><b></b></li>
        ...
        <div class="row">
            <div class="portlet box green tasks-widget">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-check"></i>الرسائل المرسلة</div>
                </div>
                                    ...
                                    <li class="">
                                        <div class="task-title">
                                            ...
                                            <span class="task-title-sp">
                                                ...
                                                /*
                                                if ($user->user_type == 4) {
                                                    $teacherr = MbTeacher::model()->findByAttributes(array('teacher_user' => $value->mdetail_receiver));
                                                    ?>
                                                    الأستاذ
                                                    <?php echo $teacherr->teacher_fname . ' ' . $teacherr->teacher_lname; ?>
