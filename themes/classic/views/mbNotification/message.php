        ...
        <ul class="dropdown-menu extended inbox">
            ...
            <li>
                <ul class="dropdown-menu-list scroller" style="height: 250px;">
                    <?php
                    foreach ($res as $i) {
                        $type = MbUser::model()->findByAttributes(array("user_id" => $i->mdetail_sender));
                        ...
                        if ($type->user_type == 3) {
                            ...
                            $name = $info->student_fname;
                            $last_name = $info->student_lname;
                        } else {
                            if ($type->user_type == 4) {
                        ...
                        <li>
                            <a href="<?php echo Yii::app()->createAbsoluteUrl("MbMessage/inbox/" . $i->mdetail_id); ?>">
                                <span class="photo"><img src="<?php echo $baseUrl; ?>/assets/attachments/photo/<?php echo $i->mdetail_sender; ?>/<?php echo $type->user_pic; ?>" alt=""/></span>
                                <span class="subject">
                                    <span class="from">
